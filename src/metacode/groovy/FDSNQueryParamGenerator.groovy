...
class FDSNQueryParamGenerator {
    ...
    String createItem(key, doc, service) {
        ...
        def binding = ['key':key, 'doc':doc, 'type':t, 'service':service, 'setter':setter, 'locidSpaceCheck':locidSpaceCheck, 'shortName':shortName]
        String out = ""
        ...
        out += engine.createTemplate(templateTextGetSet).make(binding)
    }
